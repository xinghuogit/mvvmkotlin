package com.spark.mvvmjava.java;
...
import com.spark.mvvmjava.model.WeChatSubscription;
import com.spark.mvvmjava.model.data;
...
//                emitter.onComplete();
    ...
    public String interval(StringBuffer stringBuffer) {
        ...
        stringBuffer.append("\n");
        stringBuffer.append("3秒后见log日志,当前：" + DateUtils.INSTANCE.getTimeStampToDateTime(System.currentTimeMillis()));
        stringBuffer.append("\n");
        disposableInterval = Observable.interval(3, 2, TimeUnit.SECONDS)
                ...
                .subscribe(new Consumer<Long>() {
                    ...
                    public void accept(Long t) throws Exception {
                        i++;
                        System.out.println("2秒后：" + DateUtils.INSTANCE.getTimeStampToDateTime(System.currentTimeMillis()));
    ...
    public String timer(StringBuffer stringBuffer) {
        ...
        stringBuffer.append("RxJavaToJava timer");
        stringBuffer.append("\n");
        stringBuffer.append("两秒后见log日志,当前：" + DateUtils.INSTANCE.getTimeStampToDateTime(System.currentTimeMillis()));
        stringBuffer.append("\n");
        Observable.timer(2, TimeUnit.SECONDS)
                ...
                .subscribe(new Consumer<Long>() {
                    @Override
                    public void accept(Long t) throws Exception {
                        System.out.println("两秒后：" + DateUtils.INSTANCE.getTimeStampToDateTime(System.currentTimeMillis()));
                    }
                });
        return stringBuffer.toString();
    }
