...
import com.spark.mvvmjavastudy.databinding.ActivityLivedataBinding;
import com.spark.mvvmjavastudy.viewmodel.LiveDataViewModel;
    ...
    private void addTextViewChange() {
        binding.tvLiveData.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                LogUtils.INSTANCE.i(TAG, "TextView的变化 单独使用LiveData ==> " + s);
            }
        });
        binding.tvDataBinding.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable s) {
                LogUtils.INSTANCE.i(TAG, "TextView的变化 DataBinding双向绑定 ==> " + s);
            }
        });
        binding.tvLiveDataViewModel.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable s) {
                LogUtils.INSTANCE.i(TAG, "TextView的变化 ViewModel配合LiveData设置数据 ==> " + s);
            }
        });
    }
    ...
    private void addLiveObserve() {
        ...
        liveData.observe(this, new Observer<String>() {
            ...
            public void onChanged(String s) {
                ...
                LogUtils.INSTANCE.i(TAG, "单独使用LiveData设置数据onChanged: " + s);
            }
        });
    }
