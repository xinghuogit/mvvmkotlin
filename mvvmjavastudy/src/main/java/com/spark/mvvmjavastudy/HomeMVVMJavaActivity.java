...
import com.spark.mvvmjavastudy.bean.YellowDog;
import com.spark.mvvmjavastudy.databinding.HomeMVVMJavaBinding;
import com.spark.mvvmjavastudy.databinding.ItemSimpleBinding;
import com.spark.mvvmjavastudy.ui.LiveDataActivity;
import com.spark.mvvmjavastudy.ui.RoomActivity;
import com.spark.mvvmjavastudy.ui.ViewModelActivity;
...
public class HomeMVVMJavaActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.setUserSecond(new com.spark.mvvmjavastudy.bean.alis.User("别名李云", 29));/* <!--import和Alis的使用-->*/
...
//                intent = new Intent(this, LifecycleActivitiy.class);
//                startActivity(intent);
//                LogUtils.INSTANCE.iNSTANCE.i(TAG, "123");
                LogUtils.INSTANCE.e(TAG, "123");
                break;
            case R.id.tv:
    ...
    private void addListener() {
        dog.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
            ...
            public void onPropertyChanged(Observable sender, int propertyId) {
                if (propertyId == com.spark.mvvmjavastudy.BR.name) {
                    LogUtils.INSTANCE.i(TAG, "onPropertyChanged: 名称");
                } else if (propertyId == BR._all) {
                    LogUtils.INSTANCE.i(TAG, "onPropertyChanged: 全部");
                } else {
                    LogUtils.INSTANCE.i(TAG, "onPropertyChanged: 未知错误");
                }
            }
        });
    }
